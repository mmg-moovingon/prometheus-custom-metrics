...
# Define variables
FILE="/usr/share/GeoIP/GeoIP2-City.mmdb"
OUTPUT_DIR="/var/lib/node_exporter/textfile_collector"
OUTPUT_FILE="$OUTPUT_DIR/geoip_file_age_in_days.prom"
METRIC_NAME="geoip2_city_file_age_days"
...
if [[ -f "$FILE" ]]; then
    ...
    echo "# HELP $METRIC_NAME Age of the GeoIP2-City.mmdb file in days" > $OUTPUT_FILE
